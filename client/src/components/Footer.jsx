    ...
    <footer>
      <div className="py-4 bg-slate-800 sm:grid text-white sm:grid-cols-2 sm:px-4 md:grid md:grid-cols-3 px-5 lg:grid lg:grid-cols-3 mt-2">
        <div className="naem order-1 pt-5 md:pl-7 lg:flex flex-col items-center ">
          <h1 className='font-bold text-3xl  md:text-4xl md:pt-1'>Tailor Fit Hub</h1>
          <p className='sm:text-xl sm:font-medium px-3 pt-4 text-lg font-normal md:px-0'>Make your choice</p>
          <p className='sm:text-xl sm:font-medium px-3 text-lg font-normal md:px-0'>Customized Perfection</p>
        </div>
        ...
        <div className="links order-2  md:pt-4 md:pl-5 lg:flex flex-col items-center">
          <ul className='pb-3 '>
            ...
            <Link to="/providers"><li className='pl-2 font-medium cursor-pointer  hover:text-blue-700'>Our Tailors</li></Link>
            <Link to="/registerProvider"><li className='pl-2 font-medium cursor-pointer  hover:text-blue-700'>Tailor Registration</li></Link>
            <Link to="/loginProvider"><li className='pl-2 font-medium cursor-pointer  hover:text-blue-700'>Tailor Login</li></Link>
            <Link to="/size"><li className='pl-2 font-medium cursor-pointer  hover:text-blue-700'>Size Guidance</li></Link>
      ...
      <div className=" py-4 bg-slate-700 text-white">
        <p className='text-normal text-center font-medium sm:text-lg sm:font-serif'>© Copyright 2023-2024 www.TailorFitHub.com All rights reserved. Developed by TailorFitHub</p>
      </div>

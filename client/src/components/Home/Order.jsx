  ...
  return (
    <>
        {providers && <div className='lg:px-12 md:px-8 px-2.5'>
            <h2 className='text-2xl font-semibold py-2'>Order Your Tailor Fit Online</h2>
            ...
            <div className='md:py-6 py-4 flex justify-center w-full'>
                <Link to='/providers' className='px-2 py-1 text-white bg-slate-900 rounded font-semibold'>More Tailors</Link>
            </div>
        </div>}
    </>
  )
